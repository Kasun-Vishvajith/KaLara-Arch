...
struct LinePrimitive { geometry::Point2 a,b; double widthMm=0.25; Color color; std::uint64_t sourceRevision=0; std::optional<architecture::EntityId> sourceId; };
struct FillPrimitive { geometry::Polygon2 polygon; Color color; std::uint64_t sourceRevision=0; std::optional<architecture::EntityId> sourceId; };
